  ...
  return (
      ...
      <div className="flex h-16 justify-between">
        <div className="flex">
          ...
          <div className="hidden md:ml-6 md:flex md:space-x-8">
            <Link to="/" className={`inline-flex items-center border-b-2 ${location.pathname === '/' ? 'border-indigo-500' : 'border-transparent' }  px-1 pt-1 text-sm font-medium text-gray-900`}>Discover</Link>
            <Link to="/categories" className={`inline-flex items-center border-b-2 ${location.pathname.includes("/categories") ? 'border-indigo-600': ' border-transparent'} px-1 pt-1 text-sm font-medium text-gray-500  hover:text-gray-700`}>Categories</Link>
            {session && (
              <>

            <Link to="/reviews" className={`inline-flex items-center border-b-2 ${location.pathname.includes("/reviews") ? 'border-indigo-600': ' border-transparent'} px-1 pt-1 text-sm font-medium text-gray-500  hover:text-gray-700`}>Reviews</Link>
    ...
    <div className="md:hidden" id="mobile-menu">
      <div className="space-y-1 pb-3 pt-2">
        {session && (
          <>
           <Link to="/reviews" className={`block border-l-4 ${location.pathname.includes("/reviews") ? 'border-indigo-600': ' border-transparent'} py-2 pl-3 pr-4 text-base font-medium text-gray-500  hover:bg-gray-50 hover:text-gray-700 sm:pl-5 sm:pr-6`}>Reviews</Link>
        ...
        <Link to="/" className={`block border-l-4 ${location.pathname === '/' ? 'border-indigo-500' : 'border-transparent' } bg-indigo-50 py-2 pl-3 pr-4 text-base font-medium text-indigo-700 sm:pl-5 sm:pr-6`}>Discover</Link>
        <Link to="/categories" className={`block border-l-4 border-transparent py-2 pl-3 pr-4 text-base font-medium text-gray-500 ${location.pathname.includes("/categories") ? 'border-indigo-600': ' border-transparent'} hover:bg-gray-50 hover:text-gray-700 sm:pl-5 sm:pr-6`}>Categories</Link>
